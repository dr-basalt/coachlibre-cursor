# Script pour recréer le Load Balancer avec le bon port Ingress
Write-Host "Recreation du Load Balancer avec le port Ingress..." -ForegroundColor Green
...
# 3. Créer le nouveau load balancer avec le port Ingress
...
# Créer le load balancer avec le port Ingress
$lbBody = @{
    name = $LB_NAME
