# Script de correction Cloudflare avec token intégré
Write-Host "Correction automatique Cloudflare..." -ForegroundColor Green
...
Write-Host "URL de test: https://$SUBDOMAIN.$DOMAIN" -ForegroundColor Cyan
